package com.flkj.JpaRepository;
...
public class SimpleJpaRepositoryImpl<T, ID> extends SimpleJpaRepository<T, ID> {
    ...
    public <S extends T> S save(S entity) {
        ...
        if (StringUtils.isEmpty(entityId)) {
            ...
            //}
            ////若ID为空 则设置为UUID
            //new BeanWrapperImpl(com.www.entity).setPropertyValue(entityInformation.getIdAttribute().getName(), uuid);
            //标记为新增数据
